...
public class DateUtil {
    ...
    public static Date getTommorrowDate() {
        return DateUtil.getDateFormat(dateFormat.format(getDayAfter(new Date())));
    }
    ...
    public static String getTommorrowDateStr() {
        return dateFormat.format(getDayAfter(new Date()));
    }
    ...
    public static String getNowDateBeginStr() {
        return dateFormat.format(new Date())+" 00:00:00";
    }
