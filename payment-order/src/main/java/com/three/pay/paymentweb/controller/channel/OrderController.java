...
public class OrderController {
    ...
    public ModelAndView createOrder(OrderForm orderForm,
        ...
        merUnionOrderPo.setOrderAmt(orderForm.getPayAmt());
        merUnionOrderPo.setPayAmt(orderForm.getPayAmt());
        merUnionOrderPo.setEquipIp(IpUtils.getIpAddr(request));
        merUnionOrderPo.setEquipType("WEB");
        merUnionOrderPo.setGoodsName(orderForm.getGoodsName());
        merUnionOrderPo.setUserNo("NONE");
